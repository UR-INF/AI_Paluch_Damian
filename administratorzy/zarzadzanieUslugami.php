        ...
        <div class="row justify-content-center">
            <form method="POST">
                ...
                <div class="form-group">
                    <input name="nazwa" value="<?php echo $nazwa;?>" type="text" id="dlugie" placeholder="Nazwa" class="form-control" required="">
                </div>
                    
                <div class="form-group">                   
                    <input class="form-control" name="opis" value="<?php echo $opis;?>" id="bdlugie" placeholder="Opis" required="">
